...
package com.wangyu.shortlink.project.dao.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.wangyu.shortlink.project.dao.entity.LinkLocaleStatsDO;
...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
     ...
     */
    @Insert("INSERT INTO " +
            "t_link_locale_stats (full_short_url, date, cnt, country, province, city, adcode, create_time, update_time, del_flag, gid) " +
